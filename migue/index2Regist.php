...
if(isset($_POST['bntregistrar'])){
    ...
    $val="SELECT * FROM sesion WHERE Correo = '$correo' || User ='$users'";
    $valisel= $connect->query($val);
    if($valisel->num_rows >0){
        ?>
        <h3 class="ok"> Tu User y/o Correo ya se encuentran registrados </h3>
        <?php
